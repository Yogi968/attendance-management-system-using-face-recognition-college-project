...
def manually_fill():
    global sb
    sb = tk.Tk()
    sb.iconbitmap(r"C:\Users\HP\OneDrive\Desktop\kadayogeswararao-Attendence-Management-system-main\AMS.ico")
    ...
    def err_screen_for_subject():
        ...
        ec = tk.Tk()
        ec.geometry("300x100")
        ec.iconbitmap(r"C:\Users\HP\OneDrive\Desktop\kadayogeswararao-Attendence-Management-system-main\AMS.ico")
        ec.title("Warning!!")
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            sb.destroy()
            MFW = tk.Tk()
            MFW.iconbitmap(r"C:\Users\HP\OneDrive\Desktop\kadayogeswararao-Attendence-Management-system-main\AMS.ico")
            ...
            def err_screen1():
                ...
                errsc2.iconbitmap(r"C:\Users\HP\OneDrive\Desktop\kadayogeswararao-Attendence-Management-system-main\AMS.ico")
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "kadayogeswararao-Attendence-Management-system-main\Attendence\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r"C:\Users\HP\OneDrive\Desktop\kadayogeswararao-Attendence-Management-system-main\Attendance"
                )
